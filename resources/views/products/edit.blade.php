...
<body class="bg-gray-100 p-8">
    <div class="max-w-3xl mx-auto">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">{{ __('Edit Product') }}</h2>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <form method="POST" action="{{ route('products.update', $product) }}" class="p-6">
                ...
                <div> <label for="name" class="block text-sm font-medium text-gray-700">{{ __('Name') }}</label>
                    <input id="name" type="text" name="name" value="{{ $product->name }}" required autofocus
